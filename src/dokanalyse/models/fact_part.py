...
class FactPart:
    def __init__(
        self,
        run_on_input_geometry: ogr.Geometry,
        epsg: int,
        orig_epsg: int,
        buffer: int,
        run_on_dataset: Metadata | None,
        run_algorithm: List[str],
        data: Any
    ) -> None:
