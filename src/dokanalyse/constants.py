...
AZURE_BLOB_STORAGE_CONN_STR: Final[str | None] = getenv(
    'DOKANALYSE_AZURE_BLOB_STORAGE_CONN_STR')
LOCAL_FILE_SHARE_DIR: Final[str | None] = getenv('DOKANALYSE_LOCAL_FILE_SHARE_DIR')
LOCAL_FILE_SHARE_BASE_URL: Final[str | None] = getenv('DOKANALYSE_LOCAL_FILE_SHARE_BASE_URL')
